...
CARDS=[
 ...
 dict(id="05_vertakking",type_label="Vertakking",glyph="Y",accent="Y",vid="5w_lEzZNx_E",
      ...
      rule="De aflevering splitst: +1 open draad."),
 dict(id="06_samenkomst",type_label="Samenkomst",glyph="⋎",accent="G",vid="iGBzhqSgJUk",
      ...
      rule="Voegt twee draden samen: −1 open draad."),
 dict(id="07_einde_roze",type_label="EINDE",glyph="■",accent="R",vid="boLkKd3W2sc",
      title="Drama",left=["R"],right=["CAP"],qtag="punch",
      quote="En scène. Niemand klapte.",
      rule="Sluit de draad af én claimt 'm: scoor kijkcijfers = lengte."),
 dict(id="08_einde_blauw",type_label="EINDE",glyph="■",accent="B",vid="tMGYPMJJm3o",
      title="Comazuipen",left=["B"],right=["CAP"],qtag="punch",
      quote="Morgen weten we nergens meer van.",
      rule="Cap een blauwe lijn — ook eentje die de ander bouwde."),
